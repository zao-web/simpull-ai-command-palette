...
function useText(props) {
  const {
    ...
    upperCase = false,
    variant,
    weight = _utils2.CONFIG.fontWeight,
    ...otherProps
  ...
  if (isHighlighter) {
    ...
    content = (0, _utils.createHighlighterText)({
  ...
  const classes = (0, _element.useMemo)(() => {
    ...
    if (optimizeReadabilityFor) {
      const isOptimalTextColorDark = (0, _colors.getOptimalTextShade)(optimizeReadabilityFor) === 'dark';
      sx.optimalTextColor = isOptimalTextColorDark ? /*#__PURE__*/(0, _react.css)({
        color: _utils2.COLORS.gray[900]
