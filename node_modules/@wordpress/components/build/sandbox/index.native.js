...
const Sandbox = (0, _element.forwardRef)(function Sandbox({
  ...
  function getHtmlDoc() {
    ...
    const htmlDoc = (0, _react.createElement)("html", {
      lang: lang
    }, (0, _react.createElement)("head", null, (0, _react.createElement)("title", null, title), (0, _react.createElement)("meta", {
      name: "viewport",
      content: `width=device-width, initial-scale=1${addViewportProps}`
    }), (0, _react.createElement)("style", {
      dangerouslySetInnerHTML: {
        __html: style
      }
    }), styles.map((rules, i) => (0, _react.createElement)("style", {
      key: i,
      dangerouslySetInnerHTML: {
        __html: rules
      }
    ...
    }), scripts.map(src => (0, _react.createElement)("script", {
      key: src,
      src: src
    }))));
  ...
  return (0, _react.createElement)(_reactNativeWebview.WebView, {
