export const IndicatorStyled: import("@emotion/styled").StyledComponent<Omit<import("../context").WordPressComponentProps<import("../button/types").ButtonAsButtonProps, "button", false>, "className" | "isPressed"> & {
